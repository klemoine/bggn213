...
```
    ...
    ## [1] "/Users/peanut/Desktop/BGGN213/bggn213_github/Class17"
...
```
    ...
    ## + 845/845 vertices, named, from 8abb63e:
...
```
    ...
    ## + 1544/1544 edges from 8abb63e (vertex names):
...
```
    ...
    ##  /var/folders/n0/dcnvrwqx7y1bmnx28rlv12q80000gp/T//Rtmp6gQdl8/downloaded_packages
